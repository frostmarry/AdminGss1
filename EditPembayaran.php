                                ...
                                <div class="card">
                                    ...
                                    <?php
                                        ...
                                        <form action="ProsesEditPembayaran.php" method="post" class="">
                                            ...
                                            <div class="form-group">
                                            	<span>SPP NOMINAL</span>
                                                <input type="text"  value="<?php echo $d['spp_nominal'];?>" id="spp" name="spp_nominal" placeholder="spp_nominal" class="form-control">
                                            </div>
                                            <div class="form-group">
                                            	<span>LKS</span>
                                            ...
                                            <div class="form-group">
                                            	<span>LKS NOMINAL</span>
                                                <input type="text"  value="<?php echo $d['lks_nominal'];?>" id="spp" name="lks_nominal" placeholder="lks_nominal" class="form-control">
                                            </div>
                                            <div class="form-group">
                                            	<span>DLL</span>
                                            ...
                                            <div class="form-group">
                                            	<span>DLL NOMINAL</span>
                                                <input type="text"  value="<?php echo $d['dll_nominal'];?>" id="spp" name="dll_nominal" placeholder="dll_nominal" class="form-control">
                                            </div>
                                            <div class="form-group">
                                            	<span>DENDA</span>
                                                <input type="text"  value="<?php echo $d['denda'];?>" id="dll" name="denda" placeholder="denda" class="form-control">
                                            </div>
                                            <div class="form-group">
                                            	<span>DENDA NOMINAL</span>
                                                <input type="text"  value="<?php echo $d['denda_nominal'];?>" id="spp" name="denda_nominal" placeholder="denda_nominal" class="form-control">
                                            </div>
