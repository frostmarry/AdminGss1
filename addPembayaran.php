                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div class="form-group">
                                           ...
                                           <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                <div class="form-group">
                                                <select name="spp" class="form-control" placeholder="Status">
                                            ...
                                            <div class="form-group">
                                                <input type="text" id="spp" name="spp_nominal" placeholder="spp nominal" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <div class="form-group">
                                                <select name="lks" class="form-control" placeholder="Status">
                                            ...
                                            <div class="form-group">
                                                <input type="text" id="lks_nominal" name="lks_nominal" placeholder="lks nominal" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <div class="form-group">
                                             
                                                <select name="dll" class="form-control" placeholder="Status">
                                            ...
                                            <div class="form-group">
                                                <input type="text" id="dll_nominal" name="dll_nominal" placeholder="dll nominal" class="form-control">
                                            </div>

                                             <div class="form-group">
                                                <div class="form-group">
                                             
                                                <select name="denda" class="form-control" placeholder="Status">
                                            ...
                                            <div class="form-group">
                                                <input type="text" id="dll_nominal" name="denda_nominal" placeholder="denda nominal" class="form-control">
                                            </div>
